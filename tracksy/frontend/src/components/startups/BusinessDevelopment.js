...
const BusinessDevelopment = ({ current, updateStartup }) => {
  ...
  <section className="section section-stats center">
    ...
    <div className="nav-wrapper blue-grey lighten-1">
      <ul id="nav-mobile" className="left hide-on-med-and-down">
        ...
        <li className="active"><a href="#business-development">Business Development</a></li>
...
export default connect(mapStateToProps, { updateStartup })(BusinessDevelopment);
